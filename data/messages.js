messages = {
    ...
    generic_t1: [
        "Psst! It seems this site is hosted outside the UK. GCHQ have byzantine rules that say if the site you're visiting is outside the UK, they don't need an individual warrant to intercept your communications.",
        "GCHQ's stated aim is to \"Master the internet\". Because this website is hosted outside the UK, TEMPORA's surveillance engines are likely processing what you're doing right now.",
    ...
    generic_t2: "Servers both inside and outside the UK are being used to create this website. Secret interpretations of opaque laws will govern what GCHQ can do with this. If they deem it outside the UK, they don't need an individual warrant to intercept your communications.",
    ...
    'youtube.com': "Whether a how-to guide or a cute cat video, GCHQ thinks it can spy on what you're watching on YouTube without an individual warrant since the site is hosted outside the UK.",
    ...
    'ebay.co.uk': "You're trying to bid on something, not have GCHQ intercept your communications. But since Ebay's server is located outside the UK, GCHQ deem this an 'external communication' and don't need an individual warrant to spy on you.",
    'amazon.co.uk': "You're trying to buy something, not have GCHQ intercept your communications. But since Amazon's servers are located outside the UK, GCHQ deem this an 'external communication' and don't need an individual warrant to spy on you.",
    'amazon.com': "You're trying to buy something, not have GCHQ intercept your communications. But since Amazon's servers are located outside the UK, GCHQ deem this an 'external communication' and don't need an individual warrant to spy on you.",
